...
Solusi yang diusulkan adalah sebuah sistem pencarian Smart Contracts yang sesuai dengan fungsionalitas yang dibutuhkan, agar pengembang tidak perlu lagi membuat Smart Contracts baru setiap kali mengembangkan dApp.
...
Beberapa riset yang dilakukan peninjauan untuk digunakan sebagai basis adalah riset oleh \cite{third2017linked}, \cite{aimar2023extraction}, \cite{baqa2019semantic}, \cite{cano2021toward}. Peninjauan akan didasari dengan beberapa aspek yaitu aksesibilitas dari hasil riset, kompleksitas teknis, skalabilitas, dan dukungan fungsional untuk mencapai tujuan utama.
